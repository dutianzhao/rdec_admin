...
(function() {
    ...
    document.write('<link rel="stylesheet" type="text/css" href="' + path + '/extjs/shared/example.css"/>');
    document.write('<link rel="stylesheet" type="text/css" href="' + path + '/extjs/resources/icons.css"/>');
    document.write('<script type="text/javascript" src="' + path + '/extjs/ext-all' + (rtl ? '-rtl' : '') + '.js"></script>');
    document.write('<script type="text/javascript" src="' + path + '/extjs/locale/ext-lang-zh_CN.js"></script>');
    document.write('<script type="text/javascript" src="' + path + '/rdec.js"></script>');
     document.write('<script type="text/javascript" src="' + path + '/extjs/shared/examples.js"></script>');
    if (neptune) {
